...
ply3 = mat.GlassPly.from_nominal_thickness(t3nom,"FT")
...
print("Deflection of package 2: {:.2f~P} => {:.2%~P}".format(panel.deflection[package2].to(ureg.mm), panel.deflection[package1]/defl_max))
